...
namespace Expense.Service.Test
{
    public class ExpenseServiceTest
    {
        ...
        {
            // given
            var project = new Project(ProjectType.INTERNAL, "project");
            // when
        ...
        {
            // given
            var project = new Project(ProjectType.EXTERNAL, "project_other");
            // when
            var expenseType = ExpenseService.GetExpenseCodeByProjectTypeAndName(project);
            // then
        ...
        {
            // given
            var project = new Project(ProjectType.UNEXPECTED_PROJECT_TYPE, "project");
            // when
            // then
